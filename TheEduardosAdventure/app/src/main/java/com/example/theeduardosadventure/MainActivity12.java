...
public class MainActivity12 extends AppCompatActivity implements View.OnClickListener {
        ...
        int totalQuestion = QuestionAnswer3.question3.length; /*Criando uma variável que armazena o numero de questoes e procura a perguntas no SistemaPergunta*/
        ...
        public void onClick(View view) {
            ...
            if(clickedButton.getId()==R.id.submit_btn){ /* faznedo o valor do botão ser atribuido ao botão verificar */
                if(selectedAnswer.equals(QuestionAnswer3.correctAnswers3[currentQuestionIndex])){ /*  */
                    score++;
                }
        ...
        void loadNewQuestion(){
            ...
            ansD.setText(QuestionAnswer3.choices3[currentQuestionIndex][3]);
        ...
        void restartQuiz(){
            Intent a = new Intent(MainActivity12.this,MainActivity13.class);
            startActivity(a);
